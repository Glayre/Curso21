document.getElementById("productForm").addEventListener("submit", function(event) {
    ...
    // **Validaciones**
    if (nombre === "" || descripcion === "" || categoria === "" || marca === "" || modelo === "" ||
        isNaN(precioCompra) || isNaN(precioVenta) || isNaN(costoEnvio) || isNaN(cantidadStock) || proveedor === "" ||
        fechaIngreso === "" || isNaN(peso) || isNaN(largo) || isNaN(ancho) || isNaN(alto) ||
        color === "" || material === "" || codigoBarras === "" || capacidad === "" || voltaje === "" || estado === "") {
        alert("Todos los campos deben estar correctamente llenados.");
        return;
    }
    ...
    row.querySelector(".edit").addEventListener("click", function() {
        ...
        // Elimina la fila antes de guardar cambios
        table.deleteRow(row.rowIndex - 1);
    });
